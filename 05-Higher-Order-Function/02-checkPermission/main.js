...
function checkPermission(role, isAdmin, notAdmin) {
    role === "ADMIN" ? isAdmin() : notAdmin();
  }
  
  function whenIsAdmin() {
    alert("ACCESS GRANTED");
  }
  function whenIsNotAdmin() {
    alert("ACCESS DENIED");
  }
  
  checkPermission("ADMIN", whenIsAdmin, whenIsNotAdmin);